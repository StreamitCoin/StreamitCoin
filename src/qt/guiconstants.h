...
/* Streamitcoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "StreamitCoin"
#define QAPP_ORG_DOMAIN "streamitcoin.org"
#define QAPP_APP_NAME_DEFAULT "StreamitCoin-Qt"
#define QAPP_APP_NAME_TESTNET "StreamitCoin-Qt-testnet"
