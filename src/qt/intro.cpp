...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("StreamitCoin Core"),
     ...
     * override -datadir in the streamitcoin.conf file in the default data directory
     * (to be consistent with streamitcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
