...
/** Utility functions used by the StreamitCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render StreamitCoin addresses in monospace font
...
// Parse "streamitcoin:" URI into recipient object, return true on successful parsing
