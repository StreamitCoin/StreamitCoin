...
#ifndef StreamitCoin_ZSTREAMWALLET_H
#define StreamitCoin_ZSTREAMWALLET_H
...
public:
    CzSTREAMWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZSTREAM(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZSTREAM(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //StreamitCoin_ZSTREAMWALLET_H
