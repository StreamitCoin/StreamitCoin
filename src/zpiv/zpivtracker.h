...
#ifndef StreamitCoin_ZSTREAMTRACKER_H
#define StreamitCoin_ZSTREAMTRACKER_H
...
public:
    CzSTREAMTracker(std::string strWalletFile);
    ~CzSTREAMTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzSTREAMWallet* zSTREAMWallet = NULL);
...
#endif //StreamitCoin_ZSTREAMTRACKER_H
