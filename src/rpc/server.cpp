...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop StreamitCoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "StreamitCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* StreamitCoin features */
        {"streamitcoin", "masternode", &masternode, true, true, false},
        {"streamitcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"streamitcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"streamitcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"streamitcoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"streamitcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"streamitcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"streamitcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"streamitcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"streamitcoin", "startmasternode", &startmasternode, true, true, false},
        {"streamitcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"streamitcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"streamitcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"streamitcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"streamitcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"streamitcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"streamitcoin", "mnbudget", &mnbudget, true, true, false},
        {"streamitcoin", "preparebudget", &preparebudget, true, true, false},
        {"streamitcoin", "submitbudget", &submitbudget, true, true, false},
        {"streamitcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"streamitcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"streamitcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"streamitcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"streamitcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"streamitcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"streamitcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"streamitcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"streamitcoin", "mnsync", &mnsync, true, true, false},
        {"streamitcoin", "spork", &spork, true, true, false},
        {"streamitcoin", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> streamitcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:63637/\n";
}
