...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Streamitcoin Core streamitcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  streamitcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded streamitcoin transaction") + "\n" +
                               "  streamitcoin-tx [options] -create [commands]   " + _("Create hex-encoded streamitcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded streamitcoin transaction
