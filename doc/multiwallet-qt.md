...
In order to support loading of multiple wallets in streamitcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is streamitcoin.cpp.
...
Changes to streamitcoin.cpp
----------------------
streamitcoin.cpp is the entry point into streamitcoin-qt, and as such, will require some minor modifications to provide hooks for
