Contributing to StreamitCoin Core
============================

The StreamitCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the StreamitCoin Core project, and is not to be
confused with overall StreamitCoin Network Protocol consensus changes.

Whether a pull request is merged into StreamitCoin Core rests with the project merge
...
Patches that change StreamitCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the StreamitCoin consensus, it must have been
...
The project leader is the release manager for each StreamitCoin Core release.
