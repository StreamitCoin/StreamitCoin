#!/usr/bin/env python3
# Copyright (c) 2019 The StreamitCoin Core developers
...
from fake_stake.base_test import StreamitCoin_FakeStakeTest

class zSTREAMwrappedSerialsTest(StreamitCoin_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zSTREAMs..." % DENOM_TO_USE)
...
if __name__ == '__main__':
    zSTREAMwrappedSerialsTest().main()
